...
export function AccountFilter({ accounts, value, onChange }) {
  ...
  const selectedLabel =
    value === "ALL" ? "All Accounts" : (accounts.find((a) => a.id === value)?.name ?? "All Accounts");
        ...
        <>
          ...
          >
            ...
            >
              ...
              {value === "ALL" && <span className="ml-auto w-1.5 h-1.5 rounded-full" style={{ background: C.blue }} />}
            </button>
            ...
            {accounts.map((a, i) => {
              ...
              return (
                ...
                >
                  ...
                  {isSelected && <span className="w-1.5 h-1.5 rounded-full ml-1" style={{ background: color }} />}
                </button>
              );
            })}
          </div>
