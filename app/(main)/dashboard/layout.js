      ...
      <div class="min-h-screen ">
        <div className="px-4 sm:px-6 lg:px-8 xl:px-10 py-20 sm:py-20 md:py-24 lg:py-28 xl:py-32 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              <p  className="text-[11px] font-bold uppercase tracking-[0.18em] text-violet-500 dark:text-violet-400 mb-1.5">Overview</p>
              <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-black tracking-tight text-slate-900 text-white leading-none">Dashboard</h1>
