      ...
      >
        <nav className="container mx-auto px-4 py-3.5 flex items-center justify-between">
          ...
          <div className="md:hidden flex items-center gap-2.5">
            <SignedIn>
              <MobileIconBtn href="/ai-insights"><Sparkles size={16} /></MobileIconBtn>
              <MobileIconBtn href="/dashboard"><LayoutDashboard size={16} /></MobileIconBtn>
              <MobileIconBtn href="/transaction/create"><PenBox size={16} /></MobileIconBtn>
              <UserButton afterSignOutUrl="/" />
            </SignedIn>
            <SignedOut>
              <button
        ...
        >
          ...
          >
            <p
              ...
              style={{ color: "var(--label-color)", fontFamily: "var(--font-poppins)" }}
            >
              Get Started
            </p>
            ...
            <SignInButton mode="redirect">
              <button
                ...
                style={{
                  background: "linear-gradient(135deg, #22BDFD 0%, #0ea5e9 100%)",
                  boxShadow: "0 0 28px rgba(34,189,253,0.3), 0 4px 20px rgba(0,0,0,0.2)",
