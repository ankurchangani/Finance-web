...
//         border: "1px solid rgba(34,189,253,0.2)",
...
//           style={{
//             color: tab === "login" ? "#ffffff" : "rgba(255,255,255,0.5)",
...
//           className="relative z-10 flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold"
//           style={{
//             color: tab === "signup" ? "#ffffff" : "rgba(255,255,255,0.5)",
//             fontFamily: "var(--font-poppins)",
//             transition: "color 0.2s",
//           }}
//         >
...
//   // ✅ KEY FIX: closeSidebar animates out immediately via GSAP,
//   //    then resets state — does NOT depend on useEffect re-run.
//   //    This means calling it from Login/SignUp onClick works perfectly.
//   const closeSidebar = () => {
...
//   // GSAP open-only (close is handled imperatively above)
//   useEffect(() => {
//     if (!isOpen) return;
...
//         style={{
//           background: scrolled ? "rgba(7,10,18,0.92)" : "rgba(7,10,18,0.75)",
//           backdropFilter: "blur(18px)",
//           borderBottom: "1px solid rgba(34,189,253,0.12)",
...
//                   className="text-sm font-medium text-white/70 hover:text-[#22BDFD]
...
//             <SignedIn>
//               <Link href="/ai-insights">
//                 <div className="inline-flex items-center justify-center rounded-xl h-9 w-9
...
//               <button
//                 onClick={openSidebar}
//                 className="text-white/80 p-1.5 hover:text-[#22BDFD] transition-colors rounded-lg hover:bg-white/5"
...
//           style={{
//             background: "linear-gradient(135deg, #070a12 0%, #0d1117 50%, #070d14 100%)",
...
//             style={{
//               background: "radial-gradient(circle, rgba(34,189,253,0.2) 0%, transparent 70%)",
//               filter: "blur(30px)",
//             }}
//           />
//           <div
...
//             <button
//               onClick={closeSidebar}
//               className="text-white/50 hover:text-[#22BDFD] transition-colors p-1.5 rounded-lg
...
//                     border-b border-white/[0.07] text-white/70 hover:text-[#22BDFD]
...
//                   <ChevronRight
//                     size={18}
//                     className="text-white/20 group-hover:text-[#22BDFD] group-hover:translate-x-1.5 transition-all duration-300"
//                   />
//                 </Link>
//               </div>
//             ))}
...
//           {/* ✅ Auth CTA buttons — onClick={closeSidebar} closes sidebar BEFORE Clerk opens */}
//           <div
//             ref={loginRef}
//             className="px-8 pb-12 pt-6 border-t border-white/[0.08] space-y-3"
//           >
//             <p
//               className="text-white/30 text-[10px] tracking-[0.2em] uppercase mb-5"
//               style={{ fontFamily: "var(--font-poppins)" }}
//             >
//               Get Started
//             </p>
